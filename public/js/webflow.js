...
Webflow.define('forms', function ($, _) {
  ...
  function submitWebflow(data) {
    ...
    var url = '/waitlist?email=' + emailAddress; //'https://webflow.com/api/v1/form/' + siteId;
...
//      if (!data.success) console.info('MailChimp error: ' + resp.msg);
        console.log("post done true");
      afterSubmit(data);
    }).fail(function () {
      console.log("post done false");
      afterSubmit(data);
    });
  }
